...
import CameraItems from "../_component/list/CameraItems";

const configs = [{
    name: "图片", value: "pic", isDefault: true, children:
        [
            {
                name: "裁剪参数", value: "cameraItems"
            }
        ]
}];
const MngAdminUI = ({ }) => {
    ...
    return (
        <>
            ...
            {configsChildSel === "cameraItems" && userInfo && <CameraItems userInfo={userInfo} />}
        </>
    );
}
export default MngAdminUI;